      ...
      <header>
        <div class="section-container d-flex justify-content-between">
          ...
          <div class="header__branches d-flex gap-2 align-items-center">
            <a class="text-white text-decoration-none" href="{{ route('branch.index') }}">
      ...
      <div class="nav__categories offcanvas offcanvas-start px-4 py-2" tabindex="-1" id="nav__categories"
        ...
        <div class="nav__categories-body offcanvas-body pt-0">
          ...
          <ul class="nav__list list-unstyled">
            <li class="nav__link nav__side-link"><a href="{{ route('shop.index') }}" class="py-3">جميع المنتجات</a></li>
            <li class="nav__link nav__side-link"><a href="{{ route('shop.index') }}" class="py-3">كتب عربيه</a></li>
            <li class="nav__link nav__side-link"><a href="{{ route('shop.index') }}" class="py-3">كتب انجليزية</a></li>
          </ul>
        </div>
      </div>
@auth
      ...
      <div class="section-container row">
        ...
        <div class="col-md-6 col-lg-3 px-md-4 mb-5 mb-lg-0">
          ...
          <div class="footer__list list-unstyled p-0">
            <li><a class="footer__link text-decoration-none d-inline-block text-gray py-1" href="{{ route('about.index') }}">من نحن</a></li>
            <li><a class="footer__link text-decoration-none d-inline-block text-gray py-1" href="{{ route('contact.index') }}">تواصل معنا</a></li>
            <li><a class="footer__link text-decoration-none d-inline-block text-gray py-1" href="{{ route('private.index') }}">سياسة الخصوصية</a></li>
            <li><a class="footer__link text-decoration-none d-inline-block text-gray py-1" href="{{ route('ref.index') }}">سياسة الاستبدال و
                الاسترجاع</a></li>
            <li><a class="footer__link text-decoration-none d-inline-block text-gray py-1" href="{{ route('track.index') }}">تتبع طلبك</a></li>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 px-md-4 mb-5 mb-lg-0">
          <div class="footer__list-title fw-bolder mb-1">
          ...
          <div class="footer__list">
            ...
            <div class="d-flex gap-3 mb-3">
              ...
              <div class="text-gray">{{ $branch->short_address }}</div>
            </div>
